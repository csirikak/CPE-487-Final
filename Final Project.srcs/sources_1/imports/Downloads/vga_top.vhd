...
ARCHITECTURE Behavioral OF vga_top IS
    ...
    SIGNAL grid_S             : OUT STD_LOGIC_VECTOR (2 DOWNTO 0);
    SIGNAL nextShapeGrid_S        : OUT UNSIGNED (7 DOWNTO 0);
	SIGNAL nextShapeGridAddress_S : IN  UNSIGNED (2 DOWNTO 0);
	SIGNAL score_S             : OUT UNSIGNED (10 DOWNTO 0);
	SIGNAL lines_S             : OUT UNSIGNED (5 DOWNTO 0);
	SIGNAL level_S             : OUT UNSIGNED (5 DOWNTO 0);
	SIGNAL gridAddress_S          : IN  UNSIGNED (7 DOWNTO 0);
