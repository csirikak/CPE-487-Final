...
HD_PWD='C:/Users/n_j/code/CPE 487/Final Project/Final Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tetrisComponent.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tetrisComponent.tcl
